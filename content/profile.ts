export const hero = {
  eyebrow: 'Computer Engineering · Koç University',
  tagline: 'Aiming at game development.',
  /** Single readable sentence — sits on the boat deck, never on the water. */
  statement:
    'Computer Engineering graduate in İstanbul building games with Unity and C#, with production software experience in banking, QA and embedded systems.',
  facts: [
